...
typedef struct VIRTIOGPURESOURCECREATE3D
{
    VIRTIOGPUCTRLHDR Hdr;
    uint32_t uResourceId;
    uint32_t uTarget;
...
typedef struct VIRTIOGPUCURSORPOS
{
    uint32_t uScanoutId;
    int32_t x;
    int32_t y;
...
typedef struct VIRTIOGPUUPDATECURSOR
{
    VIRTIOGPUCTRLHDR Hdr;
...
typedef struct VIRTIOGPUMOVECURSOR
{
    VIRTIOGPUCTRLHDR Hdr;
    VIRTIOGPUCURSORPOS Pos;
} VIRTIOGPUMOVECURSOR;
...
AssertCompileSize(VIRTIOGPURESOURCECREATE3D, 72);
...
AssertCompileSize(VIRTIOGPUCURSORPOS, 16);
AssertCompileSize(VIRTIOGPUUPDATECURSOR, 52);
AssertCompileSize(VIRTIOGPUMOVECURSOR, 40);
...
#define VIRTIOGPU_CMD_RESOURCE_MAP_BLOB         UINT32_C(0x0208)
#define VIRTIOGPU_CMD_RESOURCE_UNMAP_BLOB       UINT32_C(0x0209)
#define VIRTIOGPU_CMD_RESOURCE_MAP_BLOB_LEGACY  UINT32_C(0x010e)
#define VIRTIOGPU_CMD_RESOURCE_UNMAP_BLOB_LEGACY UINT32_C(0x010f)
#define VIRTIOGPU_CMD_UPDATE_CURSOR             UINT32_C(0x0300)
#define VIRTIOGPU_CMD_MOVE_CURSOR               UINT32_C(0x0301)
...
#define VIRTIOGPU_CMD_RESOURCE_CREATE_3D       UINT32_C(0x0204)
#define VIRTIOGPU_CMD_TRANSFER_TO_HOST_3D      UINT32_C(0x0205)
#define VIRTIOGPU_CMD_TRANSFER_FROM_HOST_3D    UINT32_C(0x0206)
#define VIRTIOGPU_CMD_SUBMIT_3D                UINT32_C(0x0207)
#define VIRTIOGPU_CMD_RESOURCE_MAP_BLOB_3D     UINT32_C(0x0208)
#define VIRTIOGPU_CMD_RESOURCE_UNMAP_BLOB_3D   UINT32_C(0x0209)
...
#define VIRTIOGPU_FORMAT_B8G8R8A8_UNORM     UINT32_C(1)
#define VIRTIOGPU_FORMAT_B8G8R8X8_UNORM     UINT32_C(2)
#define VIRTIOGPU_FORMAT_R8G8B8A8_UNORM     UINT32_C(67)
