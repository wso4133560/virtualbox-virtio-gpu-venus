...
typedef enum EMEXITTYPE
{
    ...
    /* X86: */
    EMEXITTYPE_X86_PIO_READ,
    EMEXITTYPE_X86_PIO_WRITE,
    EMEXITTYPE_X86_PIO_STR_READ,
    EMEXITTYPE_X86_PIO_STR_WRITE,
    EMEXITTYPE_X86_MSR_READ,
    EMEXITTYPE_X86_MSR_WRITE,
    EMEXITTYPE_X86_CPUID,
    EMEXITTYPE_X86_RDTSC,
    EMEXITTYPE_X86_MOV_CRX,
    EMEXITTYPE_X86_MOV_DRX,
    EMEXITTYPE_X86_VMREAD,
    EMEXITTYPE_X86_VMWRITE,
